        ...
        <div class="w-full max-w-4xl border-solid border-gray-300 rounded border shadow-sm">
            <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                <a class="bg-red-500 hover:bg-red-800 text-white font-bold py-2 px-4 rounded"
                    href="{{ route('mechanics.create') }}"> Create New Mechanic</a>
            </div>
                ...
                <table class="table-auto w-full rounded">
                    ...
                    <tbody>
                        ...
                        @foreach ($mechanics as $mechanic)
                            <tr>
                                <td class="border px-6 py-2">{{ $mechanic->userName }}</td>
                                <td class="border px-6 py-2">{{ $mechanic->phoneNumber }}</td>
                                <td class="border px-6 py-2">{{ $mechanic->email }}</td>
