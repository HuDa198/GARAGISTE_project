...
@section('content')
    ...
    <form action="{{ route('clients.update', $client->id) }}" method="POST" class="w-full max-w-lg mx-auto">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="mb-4">
                ...
                <input
                    ...
                    type="text" name="username" value="{{ $client->userName }}" placeholder="User Name" autofocus>
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="firstname" value="{{ $client->firstName }}" placeholder="First Name">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="lastname" value="{{ $client->lastName }}" placeholder="Last Name">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="phone_number" value="{{ $client->phoneNumber }}" placeholder="06/07-000-000-00">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="address" value="{{ $client->adress }}" placeholder="Address">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="email" name="email" value="{{ $client->email }}" placeholder="name@example.com">
                @if ($errors->has('email'))
