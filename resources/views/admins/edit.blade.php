...
@section('content')
    ...
    <form action="{{ route('admins.update', $admin->id) }}" method="POST" class="w-full max-w-lg mx-auto">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="mb-4">
                ...
                <input
                    ...
                    type="text" name="username" value="{{ $admin->userName }}" placeholder="User Name" autofocus>
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="firstname" value="{{ $admin->firstName }}" placeholder="First Name">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="lastname" value="{{ $admin->lastName }}" placeholder="Last Name">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="phone_number" value="{{ $admin->phoneNumber }}" placeholder="06/07-000-000-00">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="address" value="{{ $admin->adress }}" placeholder="Address">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="email" name="email" value="{{ $admin->email }}" placeholder="name@example.com">
                @if ($errors->has('email'))
